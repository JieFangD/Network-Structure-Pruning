...
fc1 = sum(1 for line in open("w_fc1_tp.dat","r"))
print(fc1)
fc2 = sum(1 for line in open("w_fc2_tp.dat","r"))
print(fc2)
...
sparse_w={
    ...
    "w_fc1":      tf.Variable(tf.zeros([fc1],  dtype=tf.float32),name="w_fc1"),
    "w_fc1_idx":  tf.Variable(tf.zeros([fc1,2],dtype=tf.int32),  name="w_fc1_idx"),
    ...
    "w_fc2":      tf.Variable(tf.zeros([fc2],  dtype=tf.float32),name="w_fc2"),
    "w_fc2_idx":  tf.Variable(tf.zeros([fc2,2],dtype=tf.int32),  name="w_fc2_idx"),
